...
<c:url var="action" value="/action/examples/4" scope="request"/>
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <input type="submit" aa-refresh-zones="codeZone4" class="btn btn-info" name="showCodeButton" value="Show Code"/>
            </div>
        </div>
   </fieldset>
</mvc:form>
<div id="code4Layer" class="codeLayer">
    <aa:zone id="codeZone4">
